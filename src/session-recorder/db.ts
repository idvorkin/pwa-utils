 ...
 */
export function openSessionDB(config: SessionDB): Promise<IDBDatabase> {
 ...
 */
export async function pruneOldSessions(config: SessionDB): Promise<void> {
	try {
		const db = await openSessionDB(config);
 ...
 */
export async function getPersistedSessions(
	config: SessionDB,
 ...
 */
export async function clearPersistedSessions(config: SessionDB): Promise<void> {
	try {
		const db = await openSessionDB(config);
